...
<Aside type="note">
Each template pins the current stable Cratis package versions so a scaffold builds reproducibly. Update the packages with `dotnet add package` as you normally would.
</Aside>
