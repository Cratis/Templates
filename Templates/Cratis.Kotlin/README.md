...
Scaffolded with `dotnet new cratis --language Kotlin` (or `cratis new cratis --language kotlin`).
...
```bash
dotnet new cratis --language Kotlin --Database PostgreSQL
dotnet new cratis --language Kotlin --Database MsSql
dotnet new cratis --language Kotlin --Database SQLite
```
